...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (window.scrollY > 100) setHamburgerMenuOn(false)
    };
  ...
  const handlePageChanging = (direction, delay) => {
  ...
  return (
    ...
    <div id='header'>
      ...
      <svg width="35" height="35" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link to="/"><h2>TEACHIFY</h2></Link>
      </div>
      <div>
        <ul>
          <Link to="/"><li id='headerElementHome' >Découvrir</li></Link>
          <Link to="/train"><li id='headerElementTrain' >S'entrainer</li></Link>
          <Link to="/gethelp"><li id='headerElementGetHelp'>Etre aidé</li></Link>
          <Link to="/login"><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="black" fillRule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0m0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5z" clipRule="evenodd"></path></svg></Link>
      ...
      {!hamburgerMenuOn?<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 16 16"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M2.75 12.25h10.5m-10.5-4h10.5m-10.5-4h10.5"/></svg>
        :<svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="2" d="M20 20L4 4m16 0L4 20"/></svg>}
      </div>
    </div>
    <div id='hamburgerMenu' className={hamburgerMenuOn?"hamburgerMenuOn":"hamburgerMenuOff"}>
        <ul>
          <Link to="/" onClick={()=>{setHamburgerMenuOn(false)}}><li id='headerElementHome' >Découvrir</li></Link>
          <Link to="/train" onClick={()=>{setHamburgerMenuOn(false)}}><li id='headerElementTrain' >S'entrainer</li></Link>
          <Link to="/gethelp" onClick={()=>{setHamburgerMenuOn(false)}}><li id='headerElementGetHelp'>Etre aidé</li></Link>
          <Link to="/login" onClick={()=>{setHamburgerMenuOn(false)}}><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"><path fill="black" fillRule="evenodd" d="M8 7a4 4 0 1 1 8 0a4 4 0 0 1-8 0m0 6a5 5 0 0 0-5 5a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3a5 5 0 0 0-5-5z" clipRule="evenodd"></path></svg></Link>
        </ul>
    </div>
    </>
  );
